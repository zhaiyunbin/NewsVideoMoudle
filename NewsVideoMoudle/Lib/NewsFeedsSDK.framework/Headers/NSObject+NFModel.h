 ...
 */
+ (nullable instancetype)NF_modelWithJSON:(id)json;
...
/**
 ...
 `NSString` -> SEL, Class.
 */
+ (nullable instancetype)NF_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)NF_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)NF_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)NF_modelToJSONObject;
 ...
 */
- (nullable NSData *)NF_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)NF_modelToJSONString;
 ...
 */
- (void)NF_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)NF_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)NF_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (NFModel)
 ...
 */
+ (nullable NSDictionary *)NF_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<NFModel>' to your class header.
 */
@protocol NFModel <NSObject>
@optional
